...
// This is the module that is bundled with extensions when they use `import ... from 'khulnasoft'` or
// `require('khulnasoft')`. It delegates to the extension host's runtime implementation of this module by calling
...
// (or when `khulnasoft` is not configured as an external module). Parcel does not support externals
// (https://github.com/parcel-bundler/parcel/issues/144). Webpack, Rollup, and Microbundle support externals.
module.exports = global.require('khulnasoft')
...
},{"../_lib/toInteger/index.js":"../node_modules/date-fns/esm/_lib/toInteger/index.js","../_lib/getTimezoneOffsetInMilliseconds/index.js":"../node_modules/date-fns/esm/_lib/getTimezoneOffsetInMilliseconds/index.js"}],"../node_modules/date-fns/esm/compareDesc/index.js":[function(require,module,exports) {
"use strict";
...
function compareDesc(dirtyDateLeft, dirtyDateRight, dirtyOptions) {
  ...
  var dateLeft = (0, _index.default)(dirtyDateLeft, dirtyOptions);
  var dateRight = (0, _index.default)(dirtyDateRight, dirtyOptions);
...
},{"../toDate/index.js":"../node_modules/date-fns/esm/toDate/index.js"}],"../node_modules/date-fns/esm/locale/en-US/_lib/formatDistance/index.js":[function(require,module,exports) {
"use strict";
...
function getUTCISOWeekYear(dirtyDate, dirtyOptions) {
  ...
  var startOfNextYear = (0, _index2.default)(fourthOfJanuaryOfNextYear, dirtyOptions);
  var fourthOfJanuaryOfThisYear = new Date(0);
  fourthOfJanuaryOfThisYear.setUTCFullYear(year, 0, 4);
  fourthOfJanuaryOfThisYear.setUTCHours(0, 0, 0, 0);
  var startOfThisYear = (0, _index2.default)(fourthOfJanuaryOfThisYear, dirtyOptions);
...
function startOfUTCISOWeekYear(dirtyDate, dirtyOptions) {
  ...
  var date = (0, _index2.default)(fourthOfJanuary, dirtyOptions);
  return date;
}
...
function getUTCISOWeek(dirtyDate, dirtyOptions) {
  ...
  var date = (0, _index.default)(dirtyDate, dirtyOptions);
  var diff = (0, _index2.default)(date, dirtyOptions).getTime() - (0, _index3.default)(date, dirtyOptions).getTime(); // Round the number of days to the nearest integer
...
var formatters = {
  ...
  R: function (date, token, localize, options) {
    var isoWeekYear = (0, _index3.default)(date, options); // Padding
  ...
  I: function (date, token, localize, options) {
    var isoWeek = (0, _index2.default)(date, options);
  ...
  // Day of year
  D: function (date, token, localize, options) {
    var dayOfYear = (0, _index.default)(date, options);
...
},{"../_lib/toInteger/index.js":"../node_modules/date-fns/esm/_lib/toInteger/index.js","../toDate/index.js":"../node_modules/date-fns/esm/toDate/index.js"}],"../node_modules/date-fns/esm/subMilliseconds/index.js":[function(require,module,exports) {
"use strict";
...
},{"../_lib/toInteger/index.js":"../node_modules/date-fns/esm/_lib/toInteger/index.js","../addMilliseconds/index.js":"../node_modules/date-fns/esm/addMilliseconds/index.js"}],"../node_modules/date-fns/esm/_lib/protectedTokens/index.js":[function(require,module,exports) {
"use strict";
...
exports.protectedTokens = void 0;
...
var _index6 = _interopRequireDefault(require("./_lib/formatters/index.js"));

var _index7 = _interopRequireDefault(require("./_lib/longFormatters/index.js"));

var _index8 = _interopRequireDefault(require("../subMilliseconds/index.js"));

var _index9 = require("../_lib/protectedTokens/index.js");
...
function format(dirtyDate, dirtyFormatStr, dirtyOptions) {
  ...
  var originalDate = (0, _index3.default)(dirtyDate, options);
  ...
  var timezoneOffset = (0, _index2.default)(originalDate);
  var utcDate = (0, _index8.default)(originalDate, timezoneOffset, options);
  ...
  var result = formatStr.match(longFormattingTokensRegExp).map(function (substring) {
    ...
    if (firstCharacter === 'p' || firstCharacter === 'P') {
      var longFormatter = _index7.default[firstCharacter];
    ...
    var formatter = _index6.default[firstCharacter];

    if (formatter) {
      if (!options.awareOfUnicodeTokens && (0, _index9.isProtectedToken)(substring)) {
        (0, _index9.throwProtectedError)(substring);
      }
...
},{"../_lib/toInteger/index.js":"../node_modules/date-fns/esm/_lib/toInteger/index.js","../_lib/getTimezoneOffsetInMilliseconds/index.js":"../node_modules/date-fns/esm/_lib/getTimezoneOffsetInMilliseconds/index.js","../toDate/index.js":"../node_modules/date-fns/esm/toDate/index.js","../isValid/index.js":"../node_modules/date-fns/esm/isValid/index.js","../locale/en-US/index.js":"../node_modules/date-fns/esm/locale/en-US/index.js","./_lib/formatters/index.js":"../node_modules/date-fns/esm/format/_lib/formatters/index.js","./_lib/longFormatters/index.js":"../node_modules/date-fns/esm/format/_lib/longFormatters/index.js","../subMilliseconds/index.js":"../node_modules/date-fns/esm/subMilliseconds/index.js","../_lib/protectedTokens/index.js":"../node_modules/date-fns/esm/_lib/protectedTokens/index.js"}],"../node_modules/date-fns/esm/compareAsc/index.js":[function(require,module,exports) {
"use strict";
...
},{"../toDate/index.js":"../node_modules/date-fns/esm/toDate/index.js"}],"../node_modules/date-fns/esm/differenceInMilliseconds/index.js":[function(require,module,exports) {
"use strict";
...
},{"../toDate/index.js":"../node_modules/date-fns/esm/toDate/index.js"}],"../node_modules/date-fns/esm/differenceInSeconds/index.js":[function(require,module,exports) {
"use strict";
...
function differenceInSeconds(dirtyDateLeft, dirtyDateRight, dirtyOptions) {
  ...
  var diff = (0, _index.default)(dirtyDateLeft, dirtyDateRight, dirtyOptions) / 1000;
  return diff > 0 ? Math.floor(diff) : Math.ceil(diff);
}
},{"../differenceInMilliseconds/index.js":"../node_modules/date-fns/esm/differenceInMilliseconds/index.js"}],"../node_modules/date-fns/esm/_lib/cloneObject/index.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/date-fns/esm/formatDistanceStrict/index.js":[function(require,module,exports) {
"use strict";
...
function formatDistanceStrict(dirtyDate, dirtyBaseDate, dirtyOptions) {
  ...
  if (comparison > 0) {
    dateLeft = (0, _index3.default)(dirtyBaseDate, options);
    dateRight = (0, _index3.default)(dirtyDate, options);
  } else {
    dateLeft = (0, _index3.default)(dirtyDate, options);
    dateRight = (0, _index3.default)(dirtyBaseDate, options);
  }
  ...
  var seconds = (0, _index4.default)(dateRight, dateLeft, dirtyOptions);
...
},{}],"util/memoizeAsync.ts":[function(require,module,exports) {
"use strict";
 ...
 * function
 */
function memoizeAsync(func, toKey) {
  const cache = new Map();
  return params => {
...
},{}],"blame.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getBlameStatusBarItem = exports.getBlameDecorations = exports.queryBlameHunks = exports.getAllBlameDecorations = exports.getBlameDecorationsForSelections = exports.getDecorationFromHunk = exports.getHunksForSelections = void 0;

var _compareDesc = _interopRequireDefault(require("date-fns/compareDesc"));

var _format = _interopRequireDefault(require("date-fns/format"));

var _formatDistanceStrict = _interopRequireDefault(require("date-fns/formatDistanceStrict"));

var _taggedTemplateNoop = _interopRequireDefault(require("tagged-template-noop"));

var _uri = require("./uri");

var _memoizeAsync = require("./util/memoizeAsync");
...
const getDisplayInfoFromHunk = ({
  ...
  const dateString = settings['git.blame.showPreciseDate'] ? (0, _format.default)(author.date, 'MMM dd, y') : (0, _formatDistanceStrict.default)(author.date, now, {
    addSuffix: true
  });
  const linkURL = new URL(commit.url, khulnasoft.internal.sourcegraphURL.toString()).href;
...
const getHunksForSelections = (hunks, selections) => {
  const hunksForSelections = [];

  if (!selections) {
    return hunks.map(hunk => ({
      hunk,
      selectionStartLine: hunk.startLine - 1
    }));
  }

  for (const hunk of hunks) {
    // Hunk start and end lines are 1-indexed, but selection lines are zero-indexed
    const hunkStartLineZeroBased = hunk.startLine - 1; // A Hunk's end line overlaps with the next hunk's start line.
    ...
    for (const selection of selections) {
      ...
      const selectionStartLine = hunkStartLineZeroBased < selection.start.line ? selection.start.line : hunkStartLineZeroBased;
      hunksForSelections.push({
        selectionStartLine,
        hunk
      });
    }
...
exports.getHunksForSelections = getHunksForSelections;

const getDecorationFromHunk = (hunk, now, decoratedLine, settings, khulnasoft) => {
  const {
    displayName,
    username,
    dateString,
  ...
  return {
    range: new khulnasoft.Range(decoratedLine, 0, decoratedLine, 0),
    isWholeLine: true,
    after: {
      light: {
...
exports.getDecorationFromHunk = getDecorationFromHunk;

const getBlameDecorationsForSelections = (hunks, selections, now, settings, khulnasoft) => getHunksForSelections(hunks, selections).map(({
  hunk,
  selectionStartLine
}) => getDecorationFromHunk(hunk, now, selectionStartLine, settings, khulnasoft));

exports.getBlameDecorationsForSelections = getBlameDecorationsForSelections;

const getAllBlameDecorations = (hunks, now, settings, khulnasoft) => hunks.map(hunk => getDecorationFromHunk(hunk, now, hunk.startLine - 1, settings, khulnasoft));

exports.getAllBlameDecorations = getAllBlameDecorations;
const queryBlameHunks = (0, _memoizeAsync.memoizeAsync)(async ({
  uri,
  khulnasoft,
  selections
}) => {
  const {
    ...
    rev,
    path
  } = (0, _uri.resolveURI)(uri);
  const {
    data,
    errors
  } = await khulnasoft.commands.executeCommand('queryGraphQL', (0, _taggedTemplateNoop.default)`
...
exports.queryBlameHunks = queryBlameHunks;

const getBlameDecorations = ({
  settings,
  selections,
  now,
  hunks,
  ...
  if (selections !== null && decorations === 'line') {
    return getBlameDecorationsForSelections(hunks, selections, now, settings, khulnasoft);
  } else {
    return getAllBlameDecorations(hunks, now, settings, khulnasoft);
  }
};

exports.getBlameDecorations = getBlameDecorations;

const getBlameStatusBarItem = ({
  selections,
  hunks,
  now,
  settings,
  ...
  const mostRecentHunk = hunksForSelections.sort((a, b) => (0, _compareDesc.default)(a.hunk.author.date, b.hunk.author.date))[0];
...
exports.getBlameStatusBarItem = getBlameStatusBarItem;
...
},{"date-fns/compareDesc":"../node_modules/date-fns/esm/compareDesc/index.js","date-fns/format":"../node_modules/date-fns/esm/format/index.js","date-fns/formatDistanceStrict":"../node_modules/date-fns/esm/formatDistanceStrict/index.js","tagged-template-noop":"../node_modules/tagged-template-noop/index.js","./uri":"uri.ts","./util/memoizeAsync":"util/memoizeAsync.ts"}],"extension.ts":[function(require,module,exports) {
"use strict";
...
var khulnasoft = _interopRequireWildcard(require("khulnasoft"));
...
const decorationType = khulnasoft.app.createDecorationType && khulnasoft.app.createDecorationType();
const statusBarItemType = khulnasoft.app.createStatusBarItemType && khulnasoft.app.createStatusBarItemType();

function activate(context) {
  // TODO(lguychard) khulnasoft.configuration is currently not rxjs-compatible.
  // Fix this once it has been made compatible.
  const configurationChanges = new _rxjs.BehaviorSubject(undefined);
  context.subscriptions.add(khulnasoft.configuration.subscribe(() => configurationChanges.next(undefined)));

  if (khulnasoft.app.activeWindowChanges) {
    const selectionChanges = (0, _rxjs.from)(khulnasoft.app.activeWindowChanges).pipe((0, _operators.filter)(window => window !== undefined), (0, _operators.switchMap)(window => window.activeViewComponentChanges), (0, _operators.filter)(editor => !!editor && editor.type === 'CodeEditor'), (0, _operators.switchMap)(editor => (0, _rxjs.from)(editor.selectionsChanges).pipe((0, _operators.map)(selections => ({
      editor,
      selections
    }))))); // When the configuration or current file changes, publish new decorations.

    context.subscriptions.add((0, _rxjs.combineLatest)(configurationChanges, selectionChanges).subscribe(([, {
      editor,
      selections
    ...
    const activeEditor = () => khulnasoft.app.activeWindow && khulnasoft.app.activeWindow.activeViewComponent;

    context.subscriptions.add((0, _rxjs.combineLatest)(configurationChanges, (0, _rxjs.from)(khulnasoft.workspace.openedTextDocuments)).subscribe(async () => {
  ...
  async function decorate(editor, selections) {
    const settings = khulnasoft.configuration.get().value;
    const decorations = settings['git.blame.decorations'] || 'none';
    const shouldQueryBlameHunks = Boolean(decorations === 'file' || decorations === 'line' && (selections === null || selections === void 0 ? void 0 : selections.length));

    try {
      const hunks = shouldQueryBlameHunks ? await (0, _blame.queryBlameHunks)({
        uri: editor.document.uri,
        khulnasoft,
        selections: decorations === 'line' ? selections : null
      }) : [];
      const now = Date.now(); // Check if the extension host supports status bar items (Introduced in Khulnasoft version 3.26.0).
      // If so, display blame info for the first selected line in the status bar.

      if ('setStatusBarItem' in editor) {
        editor.setStatusBarItem(statusBarItemType, (0, _blame.getBlameStatusBarItem)({
          selections,
          hunks,
          now,
          settings,
      ...
      editor.setDecorations(decorationType, (0, _blame.getBlameDecorations)({
        hunks,
        now,
        settings,
        selections,
...
},{"rxjs":"../node_modules/rxjs/_esm5/index.js","rxjs/operators":"../node_modules/rxjs/_esm5/operators/index.js","khulnasoft":"../node_modules/sourcegraph/src/index.js","./blame":"blame.ts"}]},{},["extension.ts"], null)
//# sourceMappingURL=/sourcegraph-git-extras.js.map