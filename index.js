...
const bundleCodeIntelExtensions = async () => {
  const tmpDirPath = "./khulnasoft-extensions-bundles";
  const codeIntelExtensionsRepoName = "khulnasoft-extensions-bundles";
  const codeIntelExtensionsRepoURL = `https://github.com/khulnasoft-lab/${codeIntelExtensionsRepoName}`;
...
/**
 * Fetches extension bundles + manifests from khulnasoft.com.
 */
...
/**
 * Fetches extension metadata from khulnasoft.com, downloads the extension bundle, then returns
